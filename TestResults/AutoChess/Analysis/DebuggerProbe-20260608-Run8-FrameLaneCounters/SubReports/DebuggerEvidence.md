...
| observation materialization us | 65 |
...
| active effect pre-tick processed owners | 950 |
| active effect pre-tick skipped owners | 1,450 |
| active effect pre-tick scanned slots | 1,200 |
...
- evidence: Journaling RW reads are 9,788.2/tick: GetComponentDataRW=2,245.6/tick, GetBufferRW=7,542.7/tick.
...
- evidence: DebuggerOwner avg is 115.012 ms for 2,400 materialized entities and 12 queries; GASTick avg is 1.201 ms.
