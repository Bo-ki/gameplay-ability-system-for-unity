...
World records: 88,744

## Record Operations

| Operation | Count | Per tick |
|---|---:|---:|
| GetBufferRW | 67,884 | 7,542.7 |
...
|---|---|---:|---:|
| GetBufferRW | GAS.Runtime.GASActiveEffectPreTickSystem | 15,800 | 1,755.6 |
...
| GetBufferRW | GAS.Runtime.AttributeValueBuffer | 8,250 | 916.7 |
