...
namespace GAS.Runtime.Generated
{
    public static class GASGeneratedDefinitionQueryLayouts
    {
        ...
        public static readonly EntityQueryDesc ScenarioSpawnDefinitionQuery = new EntityQueryDesc
        {
            All = new ComponentType[]
            {
                ComponentType.ReadOnly<GASGeneratedDefinitionBlobComponent<ScenarioSpawnDefinitionBlob>>(),
                ComponentType.ReadOnly<GASDefinitionCodeComponent>(),
            },
            Options = EntityQueryOptions.IncludeDisabledEntities,
        };

        public static readonly EntityQueryDesc SummonDefinitionQuery = new EntityQueryDesc
        {
            All = new ComponentType[]
            {
                ComponentType.ReadOnly<GASGeneratedDefinitionBlobComponent<SummonDefinitionBlob>>(),
                ComponentType.ReadOnly<GASDefinitionCodeComponent>(),
            },
            Options = EntityQueryOptions.IncludeDisabledEntities,
        };
        ...
        public static readonly EntityQueryDesc UnitDefinitionQuery = new EntityQueryDesc
        {
            All = new ComponentType[]
            {
                ComponentType.ReadOnly<GASGeneratedDefinitionBlobComponent<UnitDefinitionBlob>>(),
                ComponentType.ReadOnly<GASDefinitionCodeComponent>(),
            },
            Options = EntityQueryOptions.IncludeDisabledEntities,
        };
