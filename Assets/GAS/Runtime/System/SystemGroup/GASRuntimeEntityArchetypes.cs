...
namespace GAS.Runtime
{
    ...
    {
        private const int AscCoreComponentTypeCount = 38;
        ...
        public static EntityArchetype EffectCommandStream(EntityManager em)
        {
            ...
            if (!_effectCommandStream.Valid)
            {
                _effectCommandStream = em.CreateArchetype(
                    ...
                    ComponentType.ReadWrite<OwnerLocalInstantPrepareDirtyOwnerBuffer>(),
                    ComponentType.ReadWrite<ActiveEffectMutationPrepareDirtyOwnerBuffer>(),
                    ComponentType.ReadWrite<OwnerLocalGameplayFactDirtyOwnerBuffer>());
            }
        ...
        private static void WriteASCComponentTypes(ComponentType[] componentTypes)
        {
            ...
            componentTypes[index++] = ComponentType.ReadWrite<GEEffectSpecBuffer>();
