...
namespace GAS.Runtime
{
    ...
    public struct CStackingDefinition : IComponentData
    {
    ...
    public struct CStackingRuntime : IComponentData
    {
    ...
    public sealed class ConfStacking : GameplayEffectComponentConfig
    {
        ...
        public override void LoadToGameplayEffectEntity(Entity ge)
        {
            ...
            em.AddComponentData(ge, new CStackingDefinition
            {
                StackType = StackType,
            ...
            var overflowBuf = em.AddBuffer<BOverflowGEConfig>(ge);
            foreach (var effectCode in OverflowEffectCodes)
            {
                if (effectCode > 0)
                    overflowBuf.Add(new BOverflowGEConfig { GameplayEffectCode = effectCode });
            }
        }
    }
}
