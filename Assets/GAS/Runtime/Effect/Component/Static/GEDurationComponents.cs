...
{
    public struct GEDurationDefinitionComponent : IComponentData, IEnableableComponent
    {
        /// <summary>
        /// 持续时间。 小于等于0 表示无限
        /// </summary>
    ...
    public struct GEDurationRuntimeComponent : IComponentData, IEnableableComponent
    {
        /// <summary>
    ...
    public sealed class ConfDuration:GameplayEffectComponentConfig
    {
        ...
        public override void LoadToGameplayEffectEntity(EntityManager entityManager, Entity ge)
        {
            ...
            em.SetComponentEnabled<GEDurationDefinitionComponent>(ge, true);
        }
    }
}
