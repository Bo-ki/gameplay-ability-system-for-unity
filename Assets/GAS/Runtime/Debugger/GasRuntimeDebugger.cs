...
namespace GAS.Runtime
{
    ...
    public readonly struct GasRuntimeDiagnosticSnapshot
    {
            ...
            GASRuntimeDiagnosticEventBuffer[] events)
        {
            ...
            MetricFamilies = GasRuntimeMetricFamilySnapshot.Create(
                coreCounters,
                frameBackboneCounters,
                observationMaterializationCounters,
    ...
    public static class GasRuntimeDebugger
    {
        ...
        public static string ExportToText(
            ...
            int maxEvents = 0)
        {
            return GasRuntimeDerivedExportSink.ExportToText(snapshot, scorecard, maxEvents);
        }

        public static string ExportDataOrientedScorecardToText(
            in GasRuntimeDataOrientedScorecard scorecard)
        {
            return GasRuntimeDerivedExportSink.ExportDataOrientedScorecardToText(scorecard);
        }
