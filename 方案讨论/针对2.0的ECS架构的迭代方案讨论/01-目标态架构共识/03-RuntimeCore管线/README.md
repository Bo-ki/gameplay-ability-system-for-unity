...
| [03D Command Resolve 与 Target Resolve](03D-CommandResolve与TargetResolveSpec.md) | 目标态 Ability command ingest、Core Ability Producer、NativeStream command records、target resolve 和低频 request-owned TargetDataBuffer 物化路径；默认 Shell intent envelope 归 `16-02`。 |
