...
| 任务ID | 任务名 | 状态 | 目标 Spec |
|---|---|---|---|
| T2-LubanSG-Chain-1 | Definition / Luban 配置权威 - Luban SourceGenerator 配置链 - 配置生成链路验收 | 就绪 | `01/08 Luban SourceGenerator` |
| T2-LubanSG-AutoChessConfig | Definition / Luban 配置权威 - Luban SourceGenerator 配置链 - AutoChessDemo 配置方案验收 | 候选 | `01/11 AutoChessDemo Luban` |
| T2-LubanSG-Chain-2 | Definition / Luban 配置权威 - Luban SourceGenerator 配置链 - Generated Runtime Glue 边界 | 候选 | `01/08 Luban SourceGenerator` |

## 三级任务：配置生成链路验收

任务ID：`T2-LubanSG-Chain-1`

状态：`就绪`

任务名：`Definition / Luban 配置权威 - Luban SourceGenerator 配置链 - 配置生成链路验收`
