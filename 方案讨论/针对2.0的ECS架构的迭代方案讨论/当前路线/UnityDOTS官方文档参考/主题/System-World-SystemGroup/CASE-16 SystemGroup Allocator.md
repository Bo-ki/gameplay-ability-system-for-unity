...
**来源**: NativeContainer-Allocator, 官方 EntityCommandBuffer 文档
**关联规则**: SYS-02, NAT-04
...
## 模式描述
通过 `SetRateManagerCreateAllocator` + `DoubleRewindableAllocators` + `SetGroupAllocator` 为 `GasRuntimeFramePrepareSystemGroup` 建立 per-group scratch allocator。
