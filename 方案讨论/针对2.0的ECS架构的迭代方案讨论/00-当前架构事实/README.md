...
12. 2026-06-08 续轮 codedb 当前项目截面为 429 files / 429 outlines / 768 chunks / graph 443 nodes / 808 edges / 258 communities / scan ready。`ActiveEffectLifecycleOwnerSystems.cs` 已退出 SourceGenerator 输出、manifest 和 generated boundary report，但仍作为 generated runtime 物理 asmdef 内的手写 companion owner 保留；`RuntimeActiveEffect.gen.cs` 当前主要承载 generated active effect helper / job / lookup / ECB / NativeContainer owner。该拆分降低 generated boundary hit 面，不改变“剩余 generated lifecycle 仍为 MigrationProofOnly、SourceGenerator 目标态只能保留 immutable catalog / lookup / pure glue / validation”的事实判定。
